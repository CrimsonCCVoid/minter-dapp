const contractAddress = "0x124f7Ce2B2cEdAA35E917a7fe6C6dC9E9660FBEc"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to The Strange Orangutans NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Strange Orangutans NFT Collection is a unique NFT project consisting of 960 Strange Orangutans, we would love for you to join the community, help us developers out, for very low cost!.';
